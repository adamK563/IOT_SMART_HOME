...
global clientname, CONNECTED ,weight_, bottles
CONNECTED = False
r=random.randrange(1,10000000)
clientname="CocaCola"+str(r)
DHT_topic = 'pr/CocaCola/5976397/sts'
update_rate = 5000 # in msec
weight_, bottles = 1000, 100
class Mqtt_client():
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self,mc):
        ...
        self.Bottles=QLineEdit()
        self.Bottles.setText('')
        ...
        formLayot.addRow("Bottles",self.Bottles)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Coca-Cola-sensor')
    ...
    def update_data(self):
        ...
        current_data='Weight: '+str(weight_)+' bottles: '+str(bottles)
        self.connectionDock.Weight.setText(str(weight_))
        self.connectionDock.Bottles.setText(str(bottles))
